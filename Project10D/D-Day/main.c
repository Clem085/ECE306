    ...
    while(ALWAYS) {                      // Can the Operating system run
        ...
        case 1:
            ...
            case SLOWRIGHT:
                ...
                display_changed = TRUE;
                //                LEFT_FORWARD_SPEED = LSLOWCIRCLE;
                //                RIGHT_FORWARD_SPEED = RSLOWCIRCLE;
                //
                //                if (run_time >= setTime*2){
                //                    run_time_flag = 0;
                //                    motor_off();
                //                    run_time = 0;
                //                    commanding_send = WAIT;
                ...
                //            arch_next = TRUE;
                //        }else if (arch_counter < 20){
                //            RIGHT_FOR
                //        }
                dispPrint("ARCH",'1');
                display_changed = TRUE;
                //        double sec_fwd = 3.75; // Seconds For FWD
                //        double sec_fwd2 = 5.0; // Seconds For FWD2
                //        double sec_fwd3 = 3.5; // Seconds For FWD2
                //        double sec_spin = 0.7; // Seconds For SPIN
                //        double sec_wait = 2.0; // Seconds for Wait
                double sec_fwd = 2.4; // Seconds For FWD
                double sec_fwd2 = 2.5; // Seconds For FWD2
                double sec_fwd3 = 0.60; // Seconds For FWD2
                double sec_spin = 0.25; // Seconds For SPIN
                double sec_wait = 2.0; // Seconds for Wait

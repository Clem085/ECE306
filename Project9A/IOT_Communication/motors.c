...
void PWM1_LEFT_FWD(void){
    ...
    LEFT_FORWARD_SPEED = PWM1_SLOW_LEFT;
//    PWM1_RIGHT_OFF();
}
void PWM1_RIGHT_FWD(void){
    RIGHT_REVERSE_SPEED = PWM1_WHEEL_OFF;
    RIGHT_FORWARD_SPEED = PWM1_SLOW_RIGHT;
//    PWM1_LEFT_OFF();
}
...
//    int thumb = ADC_Thumb >> 9;
//    if(thumb){
//        LEFT_FORWARD_SPEED = PWM1_FAST_LEFT;
//        RIGHT_FORWARD_SPEED = PWM1_FAST_RIGHT;
//    }else{
//        LEFT_FORWARD_SPEED = PWM1_SLOW_LEFT;
//        RIGHT_FORWARD_SPEED = PWM1_SLOW_RIGHT;
//    }
...
void PWM1_LEFT_REV(void){
    LEFT_FORWARD_SPEED = PWM1_WHEEL_OFF;
    LEFT_REVERSE_SPEED = PWM1_SLOW_LEFT;
//    PWM1_RIGHT_OFF();
}
void PWM1_RIGHT_REV(void){
    RIGHT_FORWARD_SPEED = PWM1_WHEEL_OFF;
    RIGHT_REVERSE_SPEED = PWM1_SLOW_RIGHT;
//    PWM1_LEFT_OFF();
}

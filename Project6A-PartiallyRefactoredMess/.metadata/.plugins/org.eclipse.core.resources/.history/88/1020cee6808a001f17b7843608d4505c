...
extern volatile unsigned char thumb_wheel_changed;
...
void main(void){
    ...
    hexNumber = 0x03E9; // 1001[DEC] // No Idea how to actually read this value from Dial on Car.
    thumb_wheel_changed = TRUE;

...
// Port 4 Pins
#define RESET_LED              (0x01) // 4.0 DAC_CNTL1
...
#define L_FORWARD              (0x02) // 6.1 P6_0_PWM
#define R_REVERSE              (0x04) // 6.2 P6_1_PWM
#define R_FORWARD              (0x08) // 6.3 P6_2_PWM
#define L_REVERSE              (0x10) // 6.4 P6_3_PWM
#define P6_5                   (0x20) // 6.5 P6_6_PWM
#define GRN_LED                (0x40) // 6.6 GREEN LED

#define BEGINNING (0)
#define SMALL_RING_SIZE (35)
#define LARGE_RING_SIZE (35)
